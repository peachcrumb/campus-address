...
The goal of Milestone 2 was to implement the data model: the underlying set of Mongo tables and the operations upon them that would support the BowFolio application.
